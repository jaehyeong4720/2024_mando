...
class TrafficLightDetector:
    def __init__(self):
        ...
        # 구독 토픽과 메시지 타입을 변경합니다.
        self.image_sub = rospy.Subscriber("/camera2/usb_cam2/image_raw/compressed", CompressedImage, self.image_callback)
        self.red_count = 0
        self.none_count = 0
    ...
    # 이미지 콜백 함수에서 압축된 이미지를 OpenCV 이미지로 변환합니다.
    def image_callback(self, data):
        try:
            # 압축된 ROS 이미지 메시지를 OpenCV 이미지로 변환합니다.
